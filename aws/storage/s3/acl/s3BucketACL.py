...
if resposta == 'y':
    ...
    if bucket_name in bucket_names:
        print("-----//-----//-----//-----//-----//-----//-----")
        print(f"Verificando se foi configurado as permissões de leitura para entidade everyone da ACL sobre os objetos do bucket {bucket_name} (Acesso Público)")
        ...
        if public_read:
            print("-----//-----//-----//-----//-----//-----//-----")
            print(f"Já foi configurado as permissões de leitura para entidade everyone da ACL sobre os objetos do bucket {bucket_name} (Acesso Público)")
            permissions = [grant['Permission'] for grant in grants if grant['Grantee'].get('URI') == 'http://acs.amazonaws.com/groups/global/AllUsers']
            print(permissions)
        else:
            print("-----//-----//-----//-----//-----//-----//-----")
            print(f"Listando todas as permissões que a entidade everyone da ACL possuí no bucket {bucket_name}")
            permissions = [grant['Permission'] for grant in grants if grant['Grantee'].get('URI') == 'http://acs.amazonaws.com/groups/global/AllUsers']
            print(permissions)
            ...
            print("-----//-----//-----//-----//-----//-----//-----")
            print(f"Concedendo permissões de leitura para entidade everyone da ACL sobre os objetos do bucket {bucket_name}")
            s3.put_bucket_acl(Bucket=bucket_name, ACL='public-read')

            print("-----//-----//-----//-----//-----//-----//-----")
            print(f"Listando a configuração de permissões de leitura para entidade everyone da ACL sobre os objetos do bucket {bucket_name} (Acesso Público)")
            acl = s3.get_bucket_acl(Bucket=bucket_name)
            grants = acl['Grants']
            permissions = [grant['Permission'] for grant in grants if grant['Grantee'].get('URI') == 'http://acs.amazonaws.com/groups/global/AllUsers']
            print(permissions)
...
if resposta == 'y':
    ...
    if bucket_name in bucket_names:
        ...
        if public_read:
            ...
            print("-----//-----//-----//-----//-----//-----//-----")
            print(f"Restringindo as permissões de leitura para entidade everyone da ACL sobre os objetos do bucket {bucket_name}")
            ...
            if bucket_owner_preferred:
                ...
                print("-----//-----//-----//-----//-----//-----//-----")
                print(f"Alterando o proprietário dos objetos no bucket {bucket_name} para BucketOwnerEnforced")
                s3.put_bucket_ownership_controls(
                    Bucket=bucket_name,
                    OwnershipControls={
                        'Rules': [
                ...
                print(f"Não foi configurado o proprietário dos objetos no bucket {bucket_name} para BucketOwnerPreferred")
            ...
            print(f"Não foi configurado as permissões de leitura para entidade everyone da ACL sobre os objetos do bucket {bucket_name} (Acesso Público)")
    else:
        print(f"Não existe o bucket {bucket_name}")
else:
    print("Código não executado")