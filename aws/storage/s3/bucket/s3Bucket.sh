...
if [[ "$resposta" == "y" || "$resposta" == "Y" ]]; then
    ...
    if [[ "$condition" -gt 0 ]]; then
        echo "-----//-----//-----//-----//-----//-----//-----"
        echo "Já existe o bucket $bucketName"
        ...
        echo "-----//-----//-----//-----//-----//-----//-----"
        echo "Criando o bucket $bucketName"
        aws s3api create-bucket --bucket $bucketName --region $region

        echo "-----//-----//-----//-----//-----//-----//-----"
        echo "Listando o bucket $bucketName"
        aws s3api list-buckets --region $region --query "Buckets[?Name=='$bucketName'].Name" --output text
    fi
else
...
if [[ "$resposta" == "y" || "$resposta" == "Y" ]]; then
    ...
    if [[ "$condition" -gt 0 ]]; then
        ...
        echo "-----//-----//-----//-----//-----//-----//-----"
        echo "Verificando se há objetos no bucket $bucketName e removendo caso haja"
        ...
        echo "-----//-----//-----//-----//-----//-----//-----"
        echo "Removendo o bucket $bucketName"
