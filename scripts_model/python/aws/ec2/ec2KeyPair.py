...
if response == 'y':   
    try:
        ...
        if existing_key_pairs.get("KeyPairs"):
            ...
            print("-----//-----//-----//-----//-----//-----//-----")
            print(f"Removendo o arquivo de par de chaves de nome {key_pair_name}.pem se existir")
            pem_path = os.path.join(key_pair_path, f"{key_pair_name}.pem")
            if os.path.exists(pem_path):
                os.remove(pem_path)
            else:
                print(f"Não existe o arquivo de par de chaves de nome {key_pair_name}.pem")

            print("-----//-----//-----//-----//-----//-----//-----")
            print(f"Removendo o arquivo de par de chaves de nome {key_pair_name}.ppk se existir")
            ppk_path = os.path.join(key_pair_path, f"{key_pair_name}.ppk")
            if os.path.exists(ppk_path):
                os.remove(ppk_path)
            else:
                print(f"Não existe o arquivo de par de chaves de nome {key_pair_name}.ppk")
